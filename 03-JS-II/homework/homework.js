...
function esPrimo(numero) {
  ...
  //Validar que numero No es 0 o 1

  //No tenemos que probar que numero es divisible entre 1 y entre sí mismo, sino que tenemos que comprobar que
  //numero no es divisible entre otros números que no sean 1 y sí mismo, porque en ese caso deja de ser primo
